        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex">
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <!-- Dark Mode Toggle -->
                    <div class="me-4" x-data="darkMode">
                        <button @click="toggle()" type="button"
                            ...
                            <!-- Sun icon (light mode) - shown when NOT dark -->
                            ...
                            <!-- Moon icon (dark mode) - shown when dark -->
                            <svg x-show="dark" x-cloak class="h-5 w-5" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="-me-2 flex items-center sm:hidden gap-2">
                    ...
                    <div x-data="darkMode">
                        <button @click="toggle()" type="button"
                            ...
                            <!-- Sun icon (light mode) - shown when NOT dark -->
                            <svg x-show="!dark" x-cloak class="h-6 w-6" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z">
                                </path>
        ...
        <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
            ...
            <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                ...
                <div class="mt-3 space-y-1">
                    ...
                    <div class="px-4 py-2" x-data="darkMode">
                        <button @click="toggle()" type="button"
                            class="flex items-center w-full px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none">
                            <!-- Sun icon (light mode) - shown when NOT dark -->
                            <svg x-show="!dark" x-cloak class="h-5 w-5 me-3" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z">
                                </path>
